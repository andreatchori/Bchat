...
Webflow.require('ix').init([
  ...
  {"slug":"search-box","name":"Search Box","value":{"style":{},"triggers":[{"type":"click","selector":".body","preserve3d":true,"stepsA":[{"transition":"transform 500ms ease-out-quint 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"transition":"transform 500ms ease-out-quint 0ms","x":"0px","y":"-69px","z":"0px"}]},{"type":"click","selector":".news-mask","stepsA":[{"display":"block"},{"opacity":1,"transition":"opacity 500ms ease-out-quint 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease-out-quint 0ms"},{"display":"none"}]}]}},
